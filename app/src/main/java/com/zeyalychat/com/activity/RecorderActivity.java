...
import com.zeyalychat.com.utils.AppLog;
...
public class RecorderActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sample_layout_audio);
            ...
            switch(v.getId()){
                case R.id.btnStart:{
                    if (ActivityCompat.checkSelfPermission(RecorderActivity.this, Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED) {
                        ...
                        ActivityCompat.requestPermissions(RecorderActivity.this, new String[]{Manifest.permission.RECORD_AUDIO}, 0);
