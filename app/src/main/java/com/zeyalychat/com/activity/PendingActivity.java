...
public class PendingActivity extends AppCompatActivity implements OnClickListener {
    ...
    private void intView() {
        session = new Session(PendingActivity.this);

        if(status.equalsIgnoreCase("exam")) {
            binding.statustitle.setText("Unfinished");
        }else {
            binding.statustitle.setText("Pending");
        }

        binding.recyclerview.setLayoutManager(new LinearLayoutManager(PendingActivity.this, LinearLayoutManager.VERTICAL, false));
    ...
    private void onItemClickListener() {
        ...
        binding.recyclerview.addOnItemTouchListener(new RecyclerTouchListener(PendingActivity.this, binding.recyclerview,
                new RecyclerTouchListener.ClickListener() {
                    @Override
                    public void onClick(View view, int position) {
                     /*   Intent intent = new Intent(FinishedActivity.this, MeetingDetailActivity.class);
...
*/
    ...
    private void GetUnFinished() {
        ...
        if(status.equalsIgnoreCase("exam")) {
            binding.statustitle.setText("Unfinished");
            url=URLHelper.examstatuspending+ Id;

        }else {
            binding.statustitle.setText("Pending");
            url=URLHelper.homeworkstatuspending+Id;
        }
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            CompletedAdapter finishedAdapter = new CompletedAdapter(PendingActivity.this, finishedBeanArrayList);
