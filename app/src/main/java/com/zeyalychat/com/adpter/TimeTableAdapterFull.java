...
import com.zeyalychat.com.databinding.TimeRowRlBinding;

import java.util.ArrayList;
import java.util.Random;

public class TimeTableAdapterFull extends RecyclerView.Adapter<TimeTableAdapterFull.ViewHolder> {
    public ArrayList<TimeTableBean> mDataset;
    private Activity mContext;
    int row_index = 0;
    TimeRowRlBinding binding = null;


    public TimeTableAdapterFull(Activity mContext, ArrayList<TimeTableBean> myDataset) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        binding = DataBindingUtil.inflate(
                ...
                R.layout.time_row_rl, parent, false);
...
/*
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(TimeRowRlBinding binding) {
